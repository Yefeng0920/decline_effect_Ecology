...
```{r}
dat_all <- read.csv(file = "data/all effect size data edited 24-08.csv", header = TRUE)
...
# Multilevel meta-analytic approaches

we will use multilevel meta-analytic model to fit two types data:
- centered year (by mean and latest year, respectively)
- scaled year
- original year

For each type of data, we test for decline effects (sign & significance of model slopes). For the original data, we also estimate the meta-analytic overall mean, model intercept (beta0)

First to obtain overall mean (beta0) for each meta-analysis case
...
## Between-meta-analysis modelling: reduced model

Full model without consideration of the correctness of the directionality of model slope (beta2) from the first-order meta-analyses.

Use a meta-analytic model to statistically aggregate the model slope regardless of the directionality.
...
Reduced model with consideration of the correctness of the directionality of model slope (beta2) from the first-order meta-analyses.

Use a meta-analytic model to statistically aggregate the model slope with expected directionality.
...
Calculate the statistical power of the test of decline effect for each meta-analysis and meta-meta-analysis
